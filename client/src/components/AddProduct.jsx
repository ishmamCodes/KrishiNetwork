...
const AddProduct = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`${import.meta.env.VITE_API_URL || "http://localhost:4000"}/products/add`, {
        method: 'POST',
      ...
      // Refresh products
      const refreshResponse = await fetch(`${import.meta.env.VITE_API_URL || "http://localhost:4000"}/products/all`);
